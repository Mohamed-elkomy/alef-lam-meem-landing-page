        ...
        <div className="row justify-content-center">
          <div className="col-lg-8 col-md-10 col-12">
            ...
            <div className={`${styles.contactCard} rounded-4`}>
              {/* Contact Info */}
              <div className="mb-4">
                <h2 className={styles.subTitle}>بيانات التواصل</h2>
                <ul className="list-unstyled mb-0">
                  <li className="mb-2">📞 01000000000</li>
                  <li className="mb-2">✉️ support@alf-lam-meem.com</li>
                  <li>📍 القاهرة - مصر</li>
                </ul>
              </div>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <button type="submit" className={`btn w-100 ${buttons.primaryBtn}`}>
                  إرسال
                </button>
